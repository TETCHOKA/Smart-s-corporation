        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {articles.map((article) => {
              // Si l'article a un lien externe, on utilise un lien <a> normal
                    ...
                    <Card className="hover:shadow-lg transition-shadow group cursor-pointer h-full">
                      <CardContent className="p-6 space-y-4">
                        ...
                        <div className="flex items-center gap-1 text-sm font-medium text-primary">
                          Voir le document <ExternalLink className="w-4 h-4" />
                        </div>
                      </CardContent>
                    </Card>
                  </a>
              ...
              // Sinon, on utilise un Link React Router pour les articles normaux
              return (
